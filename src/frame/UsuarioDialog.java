...
public class UsuarioDialog extends javax.swing.JDialog {
     ...
     */
    public UsuarioDialog(java.awt.Frame parent, boolean modal, Usuario user) {
        super(parent, modal);
        initComponents();
        this.user = user;
    }
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(Idade)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(inputIdade, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(login)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(inputLogin, javax.swing.GroupLayout.PREFERRED_SIZE, 113, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(layout.createSequentialGroup()
    ...
    private void cadastrarBtnActionPerformed(java.awt.event.ActionEvent evt) {
        try{
            var pessoa = new domain.Pessoa(inputNome.getText(), inputRG.getText(), inputCPF.getText(), Integer.parseInt(inputIdade.getText()));
            user = new Usuario(pessoa,inputLogin.getText(),null);
            setVisible(false);
            this.dispose();
        }catch(NumberFormatException ex){
            JOptionPane.showMessageDialog(UsuarioDialog.this, "Erro ao tentar converter a idade para um número.");
        }
    }
